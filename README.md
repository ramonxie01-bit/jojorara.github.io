    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            max-width: 428px; /* 适配iPhone 15 Pro Max */
            margin: 0 auto;
            line-height: 1.4;
            font-size: 13px; /* 整体字体再缩小 */
        }
        ...
        .time-date {
            font-size: 18px; /* 可爱尺寸+幼圆字体 */
            font-weight: bold;
            margin-bottom: 4px;
            color: #ff6b8b; /* 温柔粉 */
            letter-spacing: 2px; /* 更松散的字间距更可爱 */
            text-shadow: 0 1px 2px rgba(255,107,139,0.1); /* 轻微阴影增加可爱感 */
        }
        ...
        /* 代办事项滚动容器 - 严格固定3条高度 */
        .todo-list-container {
            max-height: calc(3 * 38px); /* 3条×每条38px */
            overflow-y: auto;
